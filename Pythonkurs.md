...
### Oppgave
-	Klikk deg inn på https://dennelinkenmåendres/
...
Deretter kan du klikke på knappen `Run` *SETT INN BILDE*.
...
### Variabler
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `2.1 Variabler`*
...
### Datatyper
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `2.2 Datatyper`*
...
* Heltall
  ...
  * Årstall (2019)
* Flyttall
  * Breddegrad (59.2345) *ENDRE*
  * Lengdegrad (6.2335) *ENDRE*
...
### Aritmetikk
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `2.3 Aritmetikk`*
...
*(Det er ikke sikkert denne stemmer siden den ikke bruker full dato)*

Prøv nå å regne ut hvor mange centimeter du mangler for å bli 2 meter.

### Lister
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `2.4 Lister`*
...
Du lagrer byene i variabler slik at det er lett å holder oversikt. *eller...*
```language-python
by1 = "Oslo"
by2 = "Stockholm"
by3 = "Wien"
...
*Legg gjerne inn byer du selv har besøkt*
...
### Betingelser
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `2.5 Betingelser`*
...
### Punkter
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `3.1 Punkter`*
...
```
*Legg merke til at funksjonen nå heter `plot_punkter` og ikke `plot_punkt`*


### Kalkulering av distanse mellom punkter
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `3.2 Kalkulering av distanse`*
**TODO**
Lage flere punkter. Tegner linjer mellom og kalkulere distanser.

### Polygoner
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `3.3 Polygoner`*
**TODO**
Lage polygoner som består av flere punkter og vise de i plot.
...
### Geokoding
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `4.1 Geokoding`*
...
### Dynamiske kart med Folium
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `4.2 Dynamiske Kart`*
**TODO**
Hvordan vise et kart.

### Markers
*Dersom du henger etter eller trenger å rydde opp i filen din fort kan du åpne `4.3 Markers`*
**TODO**
Legge inn punkter i kartet og vise dem.
